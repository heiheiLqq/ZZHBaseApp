...
@implementation ZZHAFNTool
#pragma mark - Public

+(void)GET:(NSString *)url params:(NSDictionary *)params
   success:(ResponseSuccess)success fail:(ResponseFail)fail{
    
    AFHTTPSessionManager *manager = [ZZHAFNTool managerWithBaseURL:nil sessionConfiguration:NO];
    [manager GET:url parameters:params progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        
        id dic = [ZZHAFNTool responseConfiguration:responseObject];
...
+(void)GET:(NSString *)url baseURL:(NSString *)baseUrl params:(NSDictionary *)params
   success:(ResponseSuccess)success fail:(ResponseFail)fail{
    ...
    AFHTTPSessionManager *manager = [ZZHAFNTool managerWithBaseURL:baseUrl sessionConfiguration:NO];
...
+(void)uploadWithURL:(NSString *)url
    ...
    AFHTTPSessionManager *manager = [ZZHAFNTool managerWithBaseURL:baseurl sessionConfiguration:YES];
