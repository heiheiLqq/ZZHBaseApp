...
@interface ZZHProgressHUD ()<UIGestureRecognizerDelegate>
{
    UITapGestureRecognizer *tap;
}
@end

@implementation ZZHProgressHUD
UIView *bottomView;
static ZZHProgressHUD *hudManager = nil;
UIView *hudAddedView;
